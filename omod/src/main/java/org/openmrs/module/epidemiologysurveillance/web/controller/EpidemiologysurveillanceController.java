 ...
 */
package org.openmrs.module.epidemiologysurveillance.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.EpidemiologysurveillanceController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class EpidemiologysurveillanceController {
